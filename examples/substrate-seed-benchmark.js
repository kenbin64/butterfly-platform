...
function benchmark(name, iterations, fn) {
    ...
    return { name, iterations, totalMs, avgNs: (totalMs * 1000000) / iterations, opsPerSec: Math.round(iterations / (totalMs / 1000)) };
}
...
const drill1 = new flow_1.DiamondDrill(12345);
...
const drill = new flow_1.DiamondDrill(42);
...
const fixedDrill = new flow_1.DiamondDrill(99999);
...
const precisionDrill = new flow_1.DiamondDrill(777);
...
const dimDrill = new flow_1.DiamondDrill(42);
