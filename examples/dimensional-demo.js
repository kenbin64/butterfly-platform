...
const particle = (0, dimensional_1.dim)({ x: 0, y: 0, velocity: { x: 1, y: 2 } });
...
console.log("\n2. POINTS ARE DIMENSIONS");
const p = (0, dimensional_1.point)(1, 2, 3);
...
// 3. Observer pattern
console.log("\n3. OBSERVER PATTERN");
const observed = (0, dimensional_1.dim)(0);
const unsubscribe = (0, dimensional_1.watch)(observed, (val, path) => {
...
const helix = new dimensional_1.HelicalCascade();
...
console.log("\n5. MANIFOLD DIMENSION");
const m = (0, dimensional_1.manifold)();
m.place((0, dimensional_1.point)(0, 0), 0);
...
const arr = (0, dimensional_1.list)(10, 20, 30);
console.log("   list(10, 20, 30).at('1').value =", arr.at("1").value, "(direct index access)");
const matrix = (0, dimensional_1.data)([[1, 2], [3, 4]]);
console.log("   matrix.drill('0', '1').value =", matrix.drill("0", "1").value, "(direct [0][1] access)");
// 7. Address resolution
console.log("\n7. SYMBOLIC ADDRESSING");
const root = (0, dimensional_1.dim)({});
root.drill("users", "alice", "age").value = 30;
root.drill("users", "bob", "age").value = 25;
const aliceAge = (0, dimensional_1.address)("users", "alice", "age").resolve(root);
const bobAge = (0, dimensional_1.address)("users", "bob", "age").resolve(root);
...
// Observe changes
factory_1.SubstrateFactory.observe((state, event) => {
