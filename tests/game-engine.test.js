...
const game_engine_1 = require("../app/src/engine/game-engine");
describe("GameEngine", () => {
    let gameEngine;
    beforeEach(() => {
        gameEngine = new game_engine_1.GameEngine();
    });
    afterEach(() => {
        gameEngine.stop();
    });
    ...
    test("should handle entity collision detection", () => {
        ...
        const distance = Math.sqrt(Math.pow(entity2.position.x - entity1.position.x, 2) +
