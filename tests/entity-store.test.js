...
describe("EntityStore - Developer API", () => {
    let store;
    beforeEach(() => {
        store = new entity_store_1.EntityStore("test_store");
    });
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    test("Export and import state", () => {
        ...
        const store2 = new entity_store_1.EntityStore("imported_store");
    ...
    test("EntityStoreRegistry manages multiple stores", () => {
        const registry = new entity_store_1.EntityStoreRegistry();
...
describe("EntityStore - Integration", () => {
    test("Complete workflow: create, modify, snapshot, audit", () => {
        const store = new entity_store_1.EntityStore("physics");
        const changes = [];
