...
const versioned_substrate_1 = require("../core/substrate/versioned-substrate");
describe("Versioned Substrate - Geometric Storage", () => {
    let versioned;
    beforeEach(() => {
        versioned = new versioned_substrate_1.VersionedSubstrate();
    });
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    test("SubstrateRegistry indexes multiple substrates O(1)", () => {
        const registry = new versioned_substrate_1.SubstrateRegistry();
        const physics = new versioned_substrate_1.VersionedSubstrate();
        const audio = new versioned_substrate_1.VersionedSubstrate();
        const game = new versioned_substrate_1.VersionedSubstrate();
