...
const autonomous_substrate_1 = require("../core/substrate/autonomous-substrate");
describe("AutonomousSubstrate - Actor-Based NPCs", () => {
    let autonomous;
    beforeEach(() => {
        autonomous = new autonomous_substrate_1.AutonomousSubstrate();
    });
    // ═══════════════════════════════════════════════════════════════════════════
...
describe("AutonomousSubstrate - Full Narrative", () => {
    test("Complete fantasy tavern scene with multiple actors", () => {
        const autonomous = new autonomous_substrate_1.AutonomousSubstrate();
