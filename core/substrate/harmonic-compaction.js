...
exports.compactHarmonics = compactHarmonics;
exports.expandHarmonics = expandHarmonics;
exports.harmonicStorageBytes = harmonicStorageBytes;
 ...
 */
function fftReal(block, blockLen) {
    // Next power of 2
    let paddedN = 1;
    while (paddedN < blockLen)
        paddedN <<= 1;
 ...
 */
function compactHarmonics(yValues, blockSize = 4096, maxHarmonics = 64) {
    ...
    for (let b = 0; b < numBlocks; b++) {
        ...
        const harmonics = new Array(half);
 ...
 */
function expandHarmonics(manifold) {
...
function harmonicStorageBytes(manifold) {
