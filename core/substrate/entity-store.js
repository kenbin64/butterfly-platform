...
exports.EntityStoreRegistry = exports.EntityStore = void 0;
...
class EntityStore {
    constructor(name) {
        ...
        this._log = [];
        this._name = name;
        this._substrate = new versioned_substrate_1.VersionedSubstrate();
     ...
     */
    importState(data, replace = false) {
        if (replace) {
...
exports.EntityStoreRegistry = EntityStoreRegistry;
/**
 * ============================================================================
